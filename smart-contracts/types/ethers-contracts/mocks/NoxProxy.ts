...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface NoxProxyInterface extends Interface {
  ...
  export interface NoxProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): NoxProxy;
    waitForDeployment(): Promise<this>;

    interface: NoxProxyInterface;
